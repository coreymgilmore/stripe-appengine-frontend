...
**NOTE:** This app is in development.  It currently functions 100% as stated, however, changes are required to the `stripe-go` library (a dependency). Until Stripe updates their library, some modifications will be required for this app to work.  [Click here](#) for details on the required changes.
